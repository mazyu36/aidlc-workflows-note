...
function checkCounts(newSha) {
  const facts = [
    ...
    { label: "hooks", claimed: 17, actual: countFiles(newSha, "core/hooks", ".ts") },
    { label: "tools", claimed: 37, actual: countFiles(newSha, "core/tools", ".ts") },
    ...
    { label: "docs", claimed: 93, actual: countFiles(newSha, "docs", ".md") },
    { label: "harnesses", claimed: 7, actual: countDirs(newSha, "harness") },
  ];
