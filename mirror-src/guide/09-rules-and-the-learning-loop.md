...
| Sensor | 発火対象 | チェック内容 |
|--------|----------|--------|
| `claim-sources` | Intent Capture の record dir 出力 | すべての主張に見える source タグが付いていること、登録された記述・ワークフローの scope・memory テキストが正式な入力と一致すること、残存する assumption が明示的な確認と厳密に一致すること |
